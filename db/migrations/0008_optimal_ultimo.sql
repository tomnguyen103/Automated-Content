...
ALTER TABLE "reply_attempts" ADD CONSTRAINT "reply_attempts_workspace_rule_fk" FOREIGN KEY ("workspace_id","rule_id") REFERENCES "public"."auto_reply_rules"("workspace_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
