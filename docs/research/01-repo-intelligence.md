...
- Docs were reorganized in the live worktree: legacy planning docs now live under `docs/archive`, while `docs/README.md` points future sessions to the single canonical master plan and archive map (`docs/README.md:7-18`). Treat current source files and `docs/MASTER_PLAN.md` as the current planning truth (`docs/MASTER_PLAN.md:8-11`, `docs/MASTER_PLAN.md:170-185`).
